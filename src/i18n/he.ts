...
export const he: Translations = {
  ...
  openInSap: 'פתיחה בסאפ',
  countedForChains: 'נספר לשרשראות מדעיות',
  countedAsCoreHint: 'נספר כקורס ליבה',
  assigned: 'משובץ',
  assignToThisChainOnly: 'שבץ לשרשרת זו בלבד',
  assignBtn: 'שבץ',
  countedOnlyInAssigned: 'ייספר רק בשרשרת זו',
  returnToCore: 'החזר לליבה',
  prerequisitesTitle: 'דרישות קדם',
  noPrerequisites: 'אין דרישות קדם',
  replacedBy: 'מוחלף על ידי',
  auto: 'אוטומטי',
  customComposition: 'הרכב מותאם אישית',
  optionSelected: 'אפשרות נבחרה',
  autoDefault: 'אוטומטי (ברירת מחדל)',
  optionN: 'אפשרות',
  customPrereqComposition: 'הרכב קדם מותאם אישית',
  searchCourseToAdd: 'חפש קורס להוספה...',
  prereqReplacement: 'החלפת דרישת קדם',
  prereqReplacementHint: 'החלף קורס זה בקורס אחר',
  searchCourseByNameOrId: 'חפש קורס לפי שם או מספר...',
  whatDependsOnThis: 'מה תלוי בקורס זה?',
  noDependentCourses: 'אין קורסים תלויים',
  dependentCoursesCount: 'קורסים תלויים',
  inPlan: 'בתוכנית',
  noAdditionalCreditTitle: 'ללא נק"ז נוסף',
  creditConflictWith: 'התנגשות נק"ז עם',
  thisCourseNoCredit: 'קורס זה יעניק 0 נק"ז',
