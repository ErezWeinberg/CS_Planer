...
export async function fetchCourses(): Promise<Map<string, SapCourse>> {
  ...
  const LEGACY_COURSES: Record<string, { name: string; credits: number }> = {
    '01130013': { name: 'השלמות פיסיקה 1', credits: 0 },  // HS physics placement test — 0 degree credits
    ...
    '01130014': { name: 'השלמות פיסיקה 2', credits: 0 },  // HS physics placement test — 0 degree credits
